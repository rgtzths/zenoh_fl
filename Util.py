...
class Util:
    ...
    def data_division(self, n_workers):
        ...
        x_train_path = f"datasets/{self.name}/data/{self.seed}/X_train.csv"
        y_train_path = f"datasets/{self.name}/data/{self.seed}/y_train.csv"
        output_path = f"datasets/{self.name}/data/{self.seed}/{n_workers}_workers"
    ...
    def load_training_data(self):
        ...
        """
        x_train = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/X_train.csv")
        y_train = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/y_train.csv")
    ...
    def load_validation_data(self):
        ...
        """
        x_val = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/X_val.csv")
        y_val = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/y_val.csv")
        return x_val, y_val
    ...
    def load_test_data(self):
        ...
        Load the test data
        """
        x_test = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/X_test.csv")
        y_test = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/y_test.csv")
    ...
    def load_worker_data(self, n_workers, worker_id):
        ...
        """
        x_train = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/{n_workers}_workers/x_train_subset_{worker_id}.csv", header=None)
        y_train = pd.read_csv(f"datasets/{self.name}/data/{self.seed}/{n_workers}_workers/y_train_subset_{worker_id}.csv", header=None)
        return x_train, y_train
